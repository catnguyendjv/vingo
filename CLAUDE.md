...
Trạng thái: P0 code xong (schema, RLS, web đọc/học, migrate dữ liệu cũ, backup cron, UI redesign). Chưa làm: cloud provisioning (Task 17, thao tác dashboard), P1 (MCP server `study-kit-mcp` + skill tạo bài), SRS, YouTube player.
